...
void ListarProdutosCategoria(int buscaCategoria, CadastroObra obras[MAX]);
  ...
  do{
    ...
    switch(op)
    {
      ...
      case 2:
        ...
        //teste 1
        buscaCategoria = 1;
        ListarProdutosCategoria(buscaCategoria, obras);
        printf("\n\n***************************************\n");
        system("pause");
        break;
...
void cadastrar (CadastroObra obras[MAX]){
  ...
  arq = fopen("sistema_201177415_teste1.txt", "a+");
...
int contarRegistro (CadastroObra obras[MAX])
{
  FILE * arq = fopen("sistema_201177415_teste1.txt", "r");
	if(arq != NULL)
	{
		int contador = 0;
		while(1)
